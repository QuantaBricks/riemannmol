"""Confidence-state census for the atom backend's z space -- thin wrapper
over core.census.run_census using the atom research repo's own training
corpus as the default calibration sample."""
